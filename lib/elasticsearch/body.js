...
var RequestBody = /** @class */ (function () {
    ...
    RequestBody.prototype.getQueryBody = function (body) {
        ...
        var multiMatchConfig = multimatch_1.default(this.config, queryText);
        var chain = body
        ...
        if (this.config.prefixQuery) {
            chain = chain.orQuery('multi_match', 'fields', this.config.prefixQueryAttributes || searchableFields, this.config.prefixQuery);
        }
        return chain;
    };
